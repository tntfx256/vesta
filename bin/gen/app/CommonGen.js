...
var CommonGen = (function () {
    ...
    CommonGen.prototype.addSubModule = function () {
        ...
        return Util_1.Util.execSync("git submodule add -b dev " + repo.baseUrl + ":" + repo.group + "/" + repo.common + ".git " + destDir, dir);
    };
    /**
     * git init
     * git commit --message=""
    ...
    CommonGen.prototype.createCommonProject = function () {
        ...
        GitGen_1.GitGen.clone(templateRepo.baseUrl + "/" + templateRepo.group + "/" + templateRepo.common + ".git", cmnDir);
        ...
        Util_1.Util.execSync("git remote add origin " + repository.baseUrl + "/" + repository.group + "/" + repository.common + ".git", cmnDir);
    ...
    CommonGen.prototype.initWithoutSubModule = function () {
        ...
        GitGen_1.GitGen.clone(templateRepo.baseUrl + "/" + templateRepo.group + "/" + templateRepo.common + ".git", destDir);
